...
public class RamenFactory_2 {
    ...
    public int solution(int stock, int[] dates, int[] supplies, int k) {
        ...
        while(true){
            day ++;
            stock --;
            if(index < length && dates[index] == day ) {
...
//        int[] supplies = new int[]{4,1,1,1,1,1,1};
//        int stock = 6;
//        int k = 11;
        System.out.println(new RamenFactory_2().solution(stock,dates,supplies,k));
